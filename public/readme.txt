...
* Timing Symbols:
	...
	:__		perform before a data row is processed via the schema.
				Useful for applying a general cleaning function.

	_:_		perform right after a data row is processed via the 
	...
	__:		perform after all data rows have been processed. 
